	...
	export default {
		...
		data() {
			return {
				...
				text:`<p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1，test测试用例1，分隔符测试</p><p>test测试用例1，测试测试，测试测试，test测试用例1，test测试用例1</p>`,
				directoryList: [],  //目录列表
				currentPage: 0,   //当前页
		...
		methods: {
			...
			**/
			getSystemInfo() {
				...
				this.windowHeight = windowHeight-this.statusBarHeight
			...
			**/
			calcHeight() {
				if (this.contentHeight) {
					...
					this.innerHeight = (lineNum-1) * lineHeight
				}
				else {
